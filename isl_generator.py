...
class ISLGenerator:
    ...
    def _load_gloss_map(self):
        ...
        try:
            ...
            print(f"⚠️  Warning: {self.gloss_map_path} not found. Text-to-ISL will not work.")
                ...
                if word in self.gloss_map:
                    ...
                    for char in word:
                        if char in self.gloss_map:
                            ...
                            print(f"⚠️  Warning: No gloss for character '{char}', skipping.")
                i += 1
        return glosses
    ...
    def _draw_label(self, canvas, text):
        """Draws a text label at top left of frame"""
        if not text: return
